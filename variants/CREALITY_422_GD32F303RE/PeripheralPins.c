...
const PinMap PinMap_PWM[] = {
  ...
  //{PORTA_3,       TIMER1, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER1_FULL_REMAP, 3, 0)},       /* TIMER1_CH3 */
	...
	{PORTB_0,       TIMER2, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER2_FULL_REMAP, 2, 0)},       /* TIMER2_CH2 */
...
const PinMap PinMap_SD[] = {
  ...
  {PORTC_12, SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_CK */
  {PORTD_2,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_CMD */
  {NC,    NC,    0}
};
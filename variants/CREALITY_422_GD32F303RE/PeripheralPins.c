...
const PinMap PinMap_DAC[] = {
    {PORTA_4,       DAC0, GD_PIN_FUNC_ANALOG_CH(0)},    /* DAC_OUT0 */
    {PORTA_5,       DAC0, GD_PIN_FUNC_ANALOG_CH(1)},    /* DAC_OUT1 */
    {NC,    NC,    0}
};
#endif
...
const PinMap PinMap_I2C_SCL[] = {
    {PORTB_6,  I2C0, GD_PIN_DATA_REMAP(PIN_MODE_AF_OD, PIN_MODE_INPUT_FLOATING, DISABLE_I2C1_REMAP)},
    {PORTB_8,  I2C0, GD_PIN_DATA_REMAP(PIN_MODE_AF_OD, PIN_MODE_INPUT_FLOATING, I2C1_REMAP)},           /* GPIO_I2C1_REMAP */
...
const PinMap PinMap_PWM[] = {
    ...
    {PORTA_1,       TIMER1, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER1_FULL_REMAP, 1, 0)},       /* TIMER1_CH1 */
    ...
    {PORTA_2,       TIMER1, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER1_FULL_REMAP, 2, 0)},       /* TIMER1_CH2 */
    ...
    {PORTA_3_ALT2,  TIMER4, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE, 3, 0)},                      /* TIMER4_CH3 */
    {PORTA_6,       TIMER2, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER2_FULL_REMAP, 0, 0)},       /* TIMER2_CH0 */
    ...
    {PORTA_7_ALT2,  TIMER7, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE, 0, 1)},                      /* TIMER7_CH0_ON */
    {PORTA_8,       TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 0, 0)},       /* TIMER0_CH0 */
    //{PORTA_8_ALT1,  TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, TIMER0_PARTIAL_REMAP, 0, 0)},            /* TIMER0_CH0 */
    {PORTA_9,       TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 1, 0)},       /* TIMER0_CH1 */
    //{PORTA_9_ALT1,  TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, TIMER0_PARTIAL_REMAP, 1, 0)},            /* TIMER0_CH1 */
    {PORTA_10,      TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 2, 0)},       /* TIMER0_CH2 */
    //{PORTA_10_ALT1, TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, TIMER0_PARTIAL_REMAP, 2, 0)},            /* TIMER0_CH2 */
    {PORTA_11,      TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 3, 0)},       /* TIMER0_CH3 */
    ...
    {PORTB_0_ALT1,  TIMER2, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER2_FULL_REMAP, 2, 0)},       /* TIMER2_CH2 */
    ...
    {PORTB_6,       TIMER3, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER3_REMAP, 0, 0)},            /* TIMER3_CH0 */
    {PORTB_7,       TIMER3, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER3_REMAP, 1, 0)},            /* TIMER3_CH1 */
    {PORTB_8,       TIMER3, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER3_REMAP, 2, 0)},            /* TIMER3_CH2 */
    {PORTB_9,       TIMER3, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER3_REMAP, 3, 0)},            /* TIMER3_CH3 */
    ...
    {PORTB_13,      TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 0, 1)},       /* TIMER0_CH0_ON */
    {PORTB_14,      TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 1, 1)},       /* TIMER0_CH1_ON */
    {PORTB_15,      TIMER0, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_TIMER0_FULL_REMAP, 2, 1)},       /* TIMER0_CH2_ON */
    ...
    {PORTC_8_ALT,   TIMER7, GD_PIN_DATA_EXT_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE, 2, 0)},                      /* TIMER7_CH2 */
...
const PinMap PinMap_UART_TX[] = {
    {PORTA_2,       USART1, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_USART1_REMAP)},        /* USART1_TX */
    {PORTA_9,       USART0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_USART0_REMAP)},        /* USART0_TX */
...
const PinMap PinMap_UART_RX[] = {
    {PORTA_3,       USART1, GD_PIN_DATA_REMAP(PIN_MODE_INPUT, PIN_MODE_INPUT_PU, DISABLE_USART1_REMAP)},        /* USART1_RX */
    {PORTA_10,      USART0, GD_PIN_DATA_REMAP(PIN_MODE_INPUT, PIN_MODE_INPUT_PU, DISABLE_USART0_REMAP)},        /* USART0_RX */
...
const PinMap PinMap_UART_RTS[] = {
    {PORTA_1,       USART1, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_USART1_REMAP)},        /* USART1_RTS */
    ...
    {PORTB_14_ALT,  USART2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, USART2_PARTIAL_REMAP)},        /* USART2_RTS */
    {NC,    NC,    0}
};
...
const PinMap PinMap_UART_CTS[] = {
    ...
    {PORTB_13,      USART2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_USART2_FULL_REMAP)},   /* USART2_CTS */
    {PORTB_13_ALT,  USART2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, USART2_PARTIAL_REMAP)},        /* USART2_CTS */
    {NC,    NC,    0}
};

/* SPI PinMap */
const PinMap PinMap_SPI_MOSI[] = {
    {PORTA_7,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_SPI0_REMAP)},            /* SPI0_MOSI */
    //{PORTB_5,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, SPI0_REMAP)},                  /* SPI0_MOSI */
    {PORTB_5_ALT,   SPI2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI2_MOSI */
    {PORTB_15,      SPI1, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI1_MOSI */
    {NC,    NC,    0}
};

const PinMap PinMap_SPI_MISO[] = {
    {PORTA_6,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_SPI0_REMAP)},            /* SPI0_MISO */
    //{PORTB_4,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, SPI0_REMAP)},                  /* SPI0_MISO */
    {PORTB_4_ALT,   SPI2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI2_MISO */
    {PORTB_14,      SPI1, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI1_MISO */
    {NC,    NC,    0}
};

const PinMap PinMap_SPI_SCLK[] = {
    {PORTA_5,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_SPI0_REMAP)},            /* SPI0_SCLK */
    //{PORTB_3,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, SPI0_REMAP)},                  /* SPI0_SCLK */
    {PORTB_3_ALT,   SPI2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI2_SCLK */
    {PORTB_13,      SPI1, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI1_SCLK */
    {NC,    NC,    0}
};

const PinMap PinMap_SPI_SSEL[] = {
    {PORTA_4,       SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, DISABLE_SPI0_REMAP)},            /* SPI0_SSEL */
    //{PORTA_15,      SPI0, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, SPI0_REMAP)},                  /* SPI0_SSEL */
    {PORTA_15_ALT,  SPI2, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                    /* SPI2_SSEL */
...
const PinMap PinMap_SD[] = {
  {PB_8,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D4 */
  {PB_9,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D5 */
  {PC_6,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D6 */
  {PC_7,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D7 */
  {PC_8,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D0 */
  {PC_9,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D1 */
  {PC_10, SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D2 */
  {PC_11, SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_D3 */
  {PC_12, SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_CK */
  {PD_2,  SDIO, GD_PIN_DATA_REMAP(PIN_MODE_AF_PP, PIN_MODE_INPUT_PU, REMAP_NONE)},                              /* SDIO_CMD */
  {NC,    NP,    0}
};
...
int SerialUart::availableSerialN(unsigned n)
{
...
{
  return SerialUart::availableSerialN(0) > 0;
}
#endif
...
{
  return SerialUart::availableSerialN(1) > 0;
}
#endif
...
{
  return SerialUart::availableSerialN(2) > 0;
}
#endif
...
{
  return SerialUart::availableSerialN(3) > 0;
}
#endif
...
{
  return SerialUart::availableSerialN(4) > 0;
}
#endif
...
SerialUart::SerialUart(uint8_t rx, uint8_t tx, int uart_index)
{
...
int SerialUart::availableForWrite(void)
{
...
void SerialUart::_rx_complete_irq(serial_t *obj)
{
...
void SerialUart::_tx_complete_irq(serial_t *obj)
{
  if (obj == NULL) {
    return;
  }

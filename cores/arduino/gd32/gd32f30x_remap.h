    ...
    __REMAP_NAME__(ADC0_ETRGREG_REMAP)
    __REMAP_NAME__(ADC1_ETRGINS_REMAP)
    __REMAP_NAME__(ADC1_ETRGREG_REMAP)
...
#ifdef GD32F30X_CL
    __REMAP_NAME__(CAN0_PARTIAL_REMAP)
    __REMAP_NAME__(CAN0_FULL_REMAP)
    __REMAP_NAME__(ENET_REMAP
    __REMAP_NAME__(CAN1_REMAP
    __REMAP_NAME__(TIMER1ITR0_REMAP
    __REMAP_NAME__(PTP_PPS_REMAP)
#endif /* GD32F30X_CL */
    __REMAP_NAME__(TIMER8_REMAP)
    __REMAP_NAME__(TIMER9_REMAP)
    __REMAP_NAME__(TIMER10_REMAP)
    __REMAP_NAME__(TIMER12_REMAP)
    __REMAP_NAME__(TIMER13_REMAP)
    __REMAP_NAME__(EXMC_NADV_REMAP)
    __REMAP_NAME__(CTC_REMAP0)
    __REMAP_NAME__(CTC_REMAP1)

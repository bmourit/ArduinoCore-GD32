...
When using only the bits set comparabile with STM32F103RET6, it will boot. This suggests some of these chips are missing advertised features. Additionally, some chips are also missing MPU, even though GD state all chips of this version have MPUs.

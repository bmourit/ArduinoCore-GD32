...
When using only the bits set comparabile with STM32F103RET6, it will boo fine. This suggests some of these chips are missing advertised features. Additionally, some chips are also missing MCU, even though GD state all chips of this version have MCUs.
